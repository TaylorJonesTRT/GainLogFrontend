				...
				<FieldGroup>
					...
					<Field>
						<div class="flex items-center">
							...
							<a href="/auth/forgot-password" class="ml-auto text-sm underline-offset-2 hover:underline">
					...
					<FieldDescription class="text-center">
						Don't have an account? <a href="/auth/signup" class="font-semibold hover:underline"
							>Sign up</a
						>
					</FieldDescription>
				</FieldGroup>
